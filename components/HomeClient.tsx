...
export default function HomeClient() {
    const headingText = "The home for healthcare creators.";
    const headingWords = headingText.split(" ");

    // Custom split for the gradient word "home" validation
    // Actually simpler to just animate the whole block or words if convenient
    // But user asked for "Heading letters typed".

    const headingLetters1 = "The ".split("");
    const headingLetters2 = "home ".split(""); // this part has special styling
    const headingLetters3 = "for".split("");
    const headingLetters4 = "healthcare creators.".split("");
    ...
    return (
        <main className="pt-[90px]">
                    ...
                    <div className="relative bg-[#F4F4F4] rounded-[20px] lg:rounded-[40px] min-h-[500px] flex items-center mt-0 overflow-visible">
                        ...
                        <div className="relative z-10 w-full grid lg:grid-cols-2 gap-12 px-4 lg:px-20">
                            <div className="flex flex-col justify-center max-w-[640px] py-10 lg:py-16">
                                <motion.h1
                                    className="text-[32px] lg:text-[64px] font-bold leading-[1.2] lg:leading-[1.1] text-[#212236] mb-6 md:mb-8 font-sans"
                                    initial="hidden"
                                    whileInView="visible"
                                    viewport={{ once: true }}
                                ...
                                >
                                    {/* "The" */}
                                    {headingLetters1.map((char, index) => (
                                        <motion.span key={`l1-${index}`} variants={letterVariant}>{char}</motion.span>
                                    ))}

                                    {/* "home" - gradient */}
                                    <span className="bg-gradient-to-r from-[#234CD6] to-[#8430E1] bg-clip-text text-transparent">
                                        {headingLetters2.map((char, index) => (
                                            <motion.span key={`l2-${index}`} variants={letterVariant} className="text-transparent bg-clip-text bg-gradient-to-r from-[#234CD6] to-[#8430E1]">{char}</motion.span>
                                        ))}
                                    </span>

                                    {/* "for" */}
                                    {headingLetters3.map((char, index) => (
                                        <motion.span key={`l3-${index}`} variants={letterVariant}>{char}</motion.span>
                                    ))}
                                    <br />
                                    {/* "healthcare creators." */}
                                    {headingLetters4.map((char, index) => (
                                        <motion.span key={`l4-${index}`} variants={letterVariant}>{char}</motion.span>
                                    ))}
                                </motion.h1>
                                ...
                                <motion.p
                                    ...
                                    className="text-[16px] lg:text-[18px] font-normal leading-[28px] lg:leading-[32px] text-[#6D6D73] mb-10 md:mb-12 max-w-[540px]"
                                >
            ...
            {/* Decorative Wave - Revealed from masked */}
            ...
            <section id="who-we-are" className="relative py-12 bg-white overflow-hidden">
                <div className="max-w-[1440px] mx-auto px-[20px] lg:px-[100px]">
                    ...
                    {/* Cards Grid - Scale up sequentially */}
                    <motion.div
            ...
            {/* Decorative Wave - Translate in from right */}
            ...
            <section id="what-we-do" className="relative py-12 bg-[#212236] text-white overflow-hidden">
                ...
                <div className="max-w-[1440px] mx-auto px-[20px] lg:px-[100px] relative z-10">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-end">
                        ...
                        {/* Right Image - 3D Perspective + Scale */}
                        <div className="relative w-full aspect-[4/3] lg:aspect-auto lg:h-[700px] perspective-[1000px]">
                            <motion.img
            ...
            <section id="community" className="relative py-24 bg-white overflow-hidden" style={{ backgroundImage: 'url(/assets/images/wireframe.svg)', backgroundSize: 'cover', backgroundPosition: 'center' }}>
                <div className="max-w-[1440px] mx-auto px-[20px] lg:px-[100px]">
                    <div className="grid grid-cols-1 lg:grid-cols-2 lg:gap-20 items-center">
                        ...
                        {/* Right Content - Polaroid Collage - "The photo spins in" */}
                        <div className="relative h-[400px] lg:h-[700px] w-full flex items-center justify-center lg:justify-end mt-12 lg:mt-0">
                            <motion.div
                                className="relative w-full max-w-[340px] lg:max-w-[600px] h-full mx-auto lg:mt-40"
            ...
            {/* Brands Section - ALREADY ANIMATED WITH CSS 'animate-float' */}
            <section id="brands" className="relative py-32 bg-[#0A0D12] text-white overflow-hidden min-h-[800px] flex items-center">
                ...
                <div className="max-w-[1440px] mx-auto px-[20px] lg:px-[100px] relative z-10 w-full">
                    ...
                    {/* Logos on Orbits (Desktop Positioning) - CSS Animated */}
